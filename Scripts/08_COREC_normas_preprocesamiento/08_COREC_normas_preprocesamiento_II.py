...
N11_MAP: Dict[str, str] = {
 ...
 # --- Unificación demuletillas
    ...
    "dau": "dado",
    "preciu": "precio",
    "vendíatelo": "te lo vendía",
    "quedábame": "me quedaba",
    "deixé-y": "se lo dejé",
    "cáesme": "me caes",
    "xente": "gente",
    "liáo": "liado",
    ...
    "paez": "parece",
    "pallá": "para allá",
    "p’arroxar": "para arrojar",
    "pola": "por la",
    "polos": "por los",
    "peles": "por las",
    "pal": "para el",
    "díxome": "me dijo",
    "dixéronme": "me dijeron",
    "dígo-te": "te digo",
    "dígote": "te digo",
...
# --- ASTURIANU: base-guion-clítico (base >= 3) ---
RE_AST_CLIT = re.compile(
    r"\b(?P<base>\w{3,})-(?P<clit>y|ys|ylo|ylu|yla|ylos|yles)\b",
    flags=re.UNICODE
)
